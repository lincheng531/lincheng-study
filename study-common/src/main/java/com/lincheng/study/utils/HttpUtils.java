...
public class HttpUtils {
     ...
     * get
     *
     * @param host  http://dfsns.market.alicloudapi.com
     * @param path  /data/send_sms
     * @param headers headers.put("Authorization", "APPCODE");
     * @param querys  querys.put("code", code);
     * @return
     * @throws Exception
     */
